@testset "VUMPS 基态" begin
    ...
    ψ2, envs2, ϵ2 = find_groundstate(random_mps(T, [2, 2], 12), Htfim,
                                     VUMPS(maxiter = 300, tol = 1e-10))
    @test abs(real(expectation_value(ψ2, Htfim, envs2) / 2) + 4 / pi) < 1e-6
